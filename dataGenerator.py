...
def genSparseCovMatrix(n):
    
    '''Author: Greg Strabel
    This function creates a random sparse positive-definite nxn matrix
    to use as a covariance matrix in generating multivariate normal
    random variables.
    '''
